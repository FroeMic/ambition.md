      ...
      <article className="max-w-2xl mx-auto">
        <header className="mb-12">
          ...
          <p className="text-lg opacity-60">
            Variant 5: Emotion → Logic → Action (refined)
          </p>
        </header>
        ...
        <div className="space-y-6 text-base leading-relaxed">
          ...
          <p>
            Most importantly: I want to <em>found with friends</em>. People I&apos;d hang with even when not working. You&apos;re reading this because I count you among them.
          </p>
          ...
          <p>
            <strong>Michael:</strong> One deep realization: I draw energy from building and running an organization, not from coding. For the first time in a long time, I&apos;ve seen a glimpse of the future — and I know how we get there. I want to build and lead this company.
          </p>
          ...
          <p>
            &quot;Trace anatomy.&quot; Fucking amazing. We need your creativity and edginess to stand out. Our brand should be as distinctive as our product. Build a global PLG motion from scratch. And yes, our brand color can be <span className="px-1.5 py-0.5 rounded" style={{ backgroundColor: '#ed702e', color: '#ffffff' }}>orange</span>.
          </p>
          ...
          <p>
            Here is an opportunity to catapult us past those stages. Fast. Very fast. And we build it together.
          </p>
          ...
          <p>
            Now let me tell you why I think this is real.
          </p>
